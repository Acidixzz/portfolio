            ...
            <ul class="flex justify-center items-center text-gray-200" style={"margin-top: 3vh"}>
                <li class={` mx-1.5 sm:mx-6`}>
                    <a href="https://www.linkedin.com/in/owen-wilson-a8441827a" target="_blank">
                        <img class={`footer-icon${isEducation()}`} src={"/portfolio/footer-logos/li.svg"} width={50} height={50} />
                    </a>
                </li>
                <li class={` mx-1.5 sm:mx-6`}>
                    <a href="https://github.com/Acidixzz" target="_blank">
                        <img class={`footer-icon${isEducation()}`} src={"/portfolio/footer-logos/github.svg"} width={50} height={50} />
                    </a>
                </li>
                <li class={` mx-1.5 sm:mx-6`}>
                    <a href="mailto:owen80wilson@gmail.com">
                        <img class={`footer-icon${isEducation()}`} src={"/portfolio/footer-logos/mail.svg"} style={`border-width: 1px; border-color: ${isEducation() == '-uo' ? "var(--uo-green)" : "var(--skyblue)"};`} width={50} height={50} />
                    </a>
                </li>
            </ul>
